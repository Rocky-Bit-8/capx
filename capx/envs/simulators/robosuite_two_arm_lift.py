...
class RobosuiteTwoArmLiftEnv(BaseEnv):
    ...
    def move_to_joints_blocking(
        ...
        while steps < max_steps:
            ...
            # Refresh Viser after the complete user code block, not inside a
            # MuJoCo stepping loop.  The refresh performs observations and
            # rendering and can re-enter MuJoCo during step().
    ...
    def move_to_joints_blocking_arm1(
        ...
        while steps < max_steps:
            ...
            # Viser refresh is deferred until the code block completes.
